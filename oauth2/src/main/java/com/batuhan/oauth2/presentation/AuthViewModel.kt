            ...
            configuration?.let {
                ...
                val intent = getAuthorizationRequestIntent.invoke(
                    GetAuthorizationRequestIntent.Params(
                        ...
                        clientId = "2001914957-aoivqqjv0qa2d357pjsinh1l24ttqlo8.apps.googleusercontent.com",
                        email = email!!,
                        redirectUri = "com.batuhan.fconsole:/auth",
                        scope = "https://www.googleapis.com/auth/firebase.readonly https://www.googleapis.com/auth/firebase " +
